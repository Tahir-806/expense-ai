...
@section('content')
    <style>
        ...
        @keyframes pulse {
            0% { box-shadow: 0 0 0 0 rgba(56, 163, 220, 0.16);}
            70% { box-shadow: 0 0 12px 9px rgba(56, 163, 220, 0.08);}
            100% { box-shadow: 0 0 0 0 rgba(56, 163, 220, 0.13);}
        }
        #ai-suggestions h5 {
            font-weight: 700;
            color: #2563eb;
        ...
        #ai-suggestions .ai-close:hover { color: #2563eb; }
        #suggestion-text-container { position: relative; }
        #suggestion-text {
            color: #1e293b;
            font-size: 1.07rem;
            line-height: 1.7;
        ...
        #ai-suggestions .btn:active { transform: scale(0.98);}
        ...
        @media (max-width: 700px) {
            ...
            .chart-toggle-btns { flex-direction: column; gap: 0.7rem; }
        }
    </style>
...
<style>
    ...
    <script>
        $(document).ready(function() {
            // Show AI card, hide the button
            $('#show-ai-card').click(function() {
                $(this).hide();
                $('#ai-suggestions').fadeIn(200);
            });
            // Hide AI card, show the button
            $('#hide-ai-card').click(function() {
                $('#ai-suggestions').fadeOut(150, function() {
                    $('#show-ai-card').show();
                    $('#suggestion-text').html('<span class="text-muted">Click "Get Suggestion" to see AI\'s advice on your spending.</span>');
                    $('#hide-answer').hide();
            ...
            $('#get-suggestion').click(function() {
                ...
                $('#suggestion-text').html('<span class="ai-loader"></span> <span>Loading AI suggestion...</span>');
                $('#hide-answer').hide();
                $.ajax({
            ...
            $('.chart-toggle-btn').first().addClass('active');
            $('.chart-section').first().addClass('active');
        });
    </script>
    ...
    <div class="container mt-5">
        ...
        <div id="year-chart-section" class="chart-section">
            <div class="card p-3 shadow-sm" style="  width: 100%; max-height: 600px; height: 50%;  margin: 0 auto;">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Month Chart Data (Title-wise for selected month)
            ...
            // Year Chart Data (Month-wise total)
