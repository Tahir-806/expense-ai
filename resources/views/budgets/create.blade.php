...
<div class="budget-create-container container py-5">
    <div class="budget-create-card">
        ...
        {{-- Budget Form --}}
        <form method="POST" action="{{ route('budgets.store') }}" class="budget-create-form mt-2">
            @csrf
            <div class="form-group">
                <label class="form-label" for="category">Category</label>
                <input type="text" name="category" id="category" class="form-control" placeholder="e.g., Food, Travel, All" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="month" id="month" class="form-control" min="1" max="12" placeholder="Leave blank for all months">
            </div>
            <div class="form-group">
                <label class="form-label" for="year">Year (optional)</label>
                <input type="number" name="year" id="year" class="form-control" min="2000" max="{{ now()->year }}" placeholder="Leave blank for all years">
            </div>
