    ...
    <div class="expenses-center-container container py-5">
        ...
        <div class="row mb-4">
            <div class="col-md-4 mb-3">
                <div class="total-expense-summary text-center">
                    <span>Total Income (PKR):<br>
        ...
        <!-- Filter Form -->
        <form method="GET" action="{{ route('expenses.index') }}" class="expenses-filter-form mb-4">
        ...
        <!-- PIE CHARTS: Income, Expense, Outcome -->
        <div class="row mb-5">
            <div class="col-md-4 mb-4">
                <div class="card p-3 shadow-sm text-center">
                    <h6 class="mb-3">Income Pie Chart</h6>
                    <canvas id="incomePieChart" height="180"></canvas>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card p-3 shadow-sm text-center">
                    <h6 class="mb-3">Expense Pie Chart</h6>
                    <canvas id="expensePieChart" height="180"></canvas>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card p-3 shadow-sm text-center">
                    <h6 class="mb-3">Outcome Pie Chart</h6>
                    <canvas id="outcomePieChart" height="180"></canvas>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
        ...
        <div id="month-chart-section" class="chart-section">
            <div class="card p-3 shadow-sm" style="max-width: 600px; width: 100%; margin: 0 auto;">
                <h5 class="text-center mb-3">📊 Selected Month Breakdown (Expenses)</h5>
                <canvas id="monthChart" height="250"></canvas>
            </div>
            <div class="card p-3 shadow-sm" style="max-width: 600px; width: 100%; margin: 2rem auto 0 auto;">
                <h5 class="text-center mb-3">📊 Selected Month Breakdown (Income)</h5>
                <canvas id="monthIncomeChart" height="250"></canvas>
            </div>
        </div>
        <div id="year-chart-section" class="chart-section">
            <div id="year-chart-container">
                <div class="card p-3 shadow-sm mb-3">
                    <h5 class="text-center mb-3">📈 Full Year Overview (Expenses vs Income)</h5>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new Chart(document.getElementById('outcomePieChart'), {
                type: 'pie',
                data: {
                    labels: ['Outcome', 'Income', 'Expense'],
                    datasets: [{
                        data: [totalOutcome, totalIncome, totalExpense],
            ...
            // Income breakdown for selected month (by title/category)
            ...
            const ctxMonthIncome = document.getElementById('monthIncomeChart').getContext('2d');
            new Chart(ctxMonthIncome, {
                type: 'pie',
                data: {
                    labels: incomeLabels,
                    datasets: [{
                        label: 'Income',
                        data: incomeData,
                        backgroundColor: ['#10b981', '#38b6ff', '#fbbf24', '#f87171', '#a78bfa',
                            '#2563eb'
                        ],
                        borderWidth: 1
                    }]
